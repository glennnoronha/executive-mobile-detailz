...
const About: React.FC = () => (
  <div className="pt-24 pb-20 container mx-auto px-4 bg-brand-charcoal min-h-screen">
    <div className="max-w-3xl mx-auto">
      <h1 className="text-4xl font-bold font-heading text-white mb-6">About Executive Mobile Detailz</h1>
      <p className="text-lg text-brand-silver mb-6">
        Founded in Amarillo, Texas, Executive Mobile Detailz was built on a simple premise: quality automotive care shouldn't be inconvenient. 
